...
2) Have Mongoose installed to connect to MongoDB
3) Have Express installed

"some other packeges may be required depending on the system."

example: npm install --express

Server needs to run locally to load the html pages.
